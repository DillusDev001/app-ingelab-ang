...
@Component({
  selector: 'app-recepcion-frx-lista',
  templateUrl: './recepcion-frx-lista.component.html',
  styleUrls: ['./recepcion-frx-lista.component.css']
})
export class RecepcionFrxListaComponent implements OnInit {
  /** -------------------------------------- Constructor -------------------------------------- **/
  constructor(
  ...
  /** ----------------------------------- Consultas Sevidor ----------------------------------- **/
  getListaRecepcionFrx() {
    this.dataRecepcion = [];
    this.recepcionFrxService.recepcionFrxGet().subscribe(result => {
      result as ApiResult;
