...
export class ForgotComponent implements OnInit {
  ...
  onClickValidar() {
    if (this.formForgot.valid) {
      ...
      const newpass = String(this.formForgot.controls.password.value);

      let data = { user, pregunta, respuesta, newpass }

      this.authService.authGotPassword(data).subscribe(data => {
        this.result = data
