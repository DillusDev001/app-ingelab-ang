...
@Component({
  selector: 'app-lista-cotizacion-servicio',
  templateUrl: './lista-cotizacion-servicio.component.html',
  styleUrls: ['./lista-cotizacion-servicio.component.css']
})
export class ListaCotizacionServicioComponent implements OnInit {
