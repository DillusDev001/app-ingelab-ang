...
export function pdfCotizacionFRX(
    type: string, objCotizacionFRX: CotizacionFrx,
    ...
    var pdfCreation = {
        ...
        content: [
            // Título
            {
                text: 'COTIZACIÓN LABORATORIO FRX',
                style: 'header',
                        ...
                        table: {
                            ...
                            body: [
                                [
                                    ...
                                    {
                                        border: [false],
                                        text: myFormatDate(objCotizacionFRX.fec_solicitud), style: 'text',
                                    }
                                ],
                                [
                                    {
                                    ...
                                    {
                                        border: [false],
                                        text: myFormatDate(objCotizacionFRX.fec_emision), style: 'text',
                                    }
                                ],
                            ]
                        },
                ...
                table: {
                    ...
                    body: [
                        ...
                        [
                            ...
                            {
                                border: [false, false, false, true],
                                text: objCotizacionFRX.observacion, style: 'text', colSpan: 3
                            },
                            {},
                            {}
                        ]
            ...
            // Costos
            {
                ...
                margin: [0, 0, 0, 0] as Margins // posiblemente agregar el margin bottom de 120
            }
        ],
